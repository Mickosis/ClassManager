...
Public Class ClassCreateHome
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Create.Click
        ...
        Else
            ...
            End While
            reader.Close()
            SQLSTR = "CREATE TABLE '" & TextBox2.Text & "' (StudentID INTEGER NOT NULL UNIQUE, FirstName TEXT, LastName TEXT, pQuiz INTEGER DEFAULT 0, pAttend INTEGER DEFAULT 0, pRecite INTEGER DEFAULT 0, pProject INTEGER DEFAULT 0, pHomework INTEGER DEFAULT 0, pOthers INTEGER DEFAULT 0, mQuiz INTEGER DEFAULT 0, mAttend INTEGER DEFAULT 0, mRecite INTEGER DEFAULT 0, mProject INTEGER DEFAULT 0, mHomework INTEGER DEFAULT 0, mOthers INTEGER DEFAULT 0, fQuiz INTEGER DEFAULT 0, fAttend INTEGER DEFAULT 0, fRecite INTEGER DEFAULT 0, fProject INTEGER DEFAULT 0, fHomework INTEGER DEFAULT 0, fOthers INTEGER DEFAULT 0, pGrade INTEGER DEFAULT 0, mGrade INTEGER DEFAULT 0, fGrade  INTEGER DEFAULT 0, semGrade INTEGER DEFAULT 0)"
            alterDB()
