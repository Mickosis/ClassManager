...
Public Class AddFinalGrades
    ...
    Public Sub LoadGrades()
        ...
        ListView1.Columns.Add("Finals", 60)
        While (SQLDR.Read())
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        If Not ListView1.SelectedItems.Count = 0 Then
            With ListView1.SelectedItems.Item(0)
                ...
                DBConn()
                Dim querystring3 As String = "SELECT fQuizRaw, fAttendRaw, fReciteRaw, fProjectRaw, fHomeworkRaw, fOthersRaw, fExamRaw FROM '" & ClassIntl & "' WHERE  StudentID = '" & StudID & "' "
    ...
    Private Sub Finals_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.MouseHover

        Button1.Image = My.Resources.Browse_and_Update_pressed

    End Sub

    Private Sub Finals_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.MouseLeave
    ...
    Private Sub Finals2_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.MouseHover

        Button2.Image = My.Resources.Browse_and_Update_pressed

    End Sub

    Private Sub Finals2_MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.MouseLeave
