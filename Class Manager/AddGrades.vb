...
Public Class AddGrades
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If TextBox2.Text + TextBox3.Text + TextBox4.Text > 100 Then
            MsgBox("Weights must not exceed 100")
        ElseIf TextBox2.Text + TextBox3.Text + TextBox4.Text < 100 Then
            MsgBox("Weights must be equal to 100")
        ElseIf TextBox14.Text + TextBox15.Text + TextBox16.Text + TextBox17.Text > 100 Then
            MsgBox("Weights must not exceed 100")
        ElseIf TextBox14.Text + TextBox15.Text + TextBox16.Text + TextBox17.Text < 100 Then
            MsgBox("Weights must be equal to 100")
        Else
