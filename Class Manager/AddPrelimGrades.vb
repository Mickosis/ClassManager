...
Public Class AddPrelimGrades
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        If Not ListView1.SelectedItems.Count = 0 Then
            With ListView1.SelectedItems.Item(0)
                ...
                DBConn()
                Dim querystring3 As String = "SELECT pQuizRaw, pAttendRaw, pReciteRaw, pProjectRaw, pHomeworkRaw, pOthersRaw, pExamRaw FROM '" & ClassIntl & "' WHERE  StudentID = '" & StudID & "' "
    ...
    Public Sub LoadGrades()
        ...
        ListView1.Columns.Add("Prelim", 60)
        While (SQLDR.Read())
    ...
    Private Sub Btn2MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.MouseHover

        Button2.Image = My.Resources.Browse_and_Update_pressed

    End Sub

    Private Sub Btn2MouseLeave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.MouseLeave
